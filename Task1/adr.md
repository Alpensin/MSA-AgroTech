...
В альтернативном решение управление расписанием перенесено в Центральный Узел. Это упрощает в будущем развитие API для управления фермами. Но потребует создания альтернативных способов изменения расписания на ферме в случае отсутствия связи между фермой и центральным узлом.
Тем не менее ферма остается высокоавтономна, передача данных между фермой и Центральным узлом также не требует значительной пропускной способности, синхронизация происходит за счет надежной и развитой технологии на основе внешних решений RabbitMQ и Kafka, что упрощает разработку.
